...
public interface StockService {
    ...
    /**
     * delegates to every endpoint on the route in a multicasting fashion
     *
     * @param endPoint the entry point to the multicast
     * @param item     the item to broadcast
     * @return the aggregated result of the delegees
     */
    Boolean canItemBeDeletedMulticast(String endPoint, Item item);
}